...
return array(
	...
	'tx_kesearch_indexer_filetypes_ppt' => $extensionPath . 'indexer/filetypes/class.tx_kesearch_indexer_filetypes_ppt.php',
        'tx_kesearch_indexer_filetypes_pptx' => $extensionPath . 'indexer/filetypes/class.tx_kesearch_indexer_filetypes_pptx.php',
	'tx_kesearch_indexer_filetypes_doc' => $extensionPath . 'indexer/filetypes/class.tx_kesearch_indexer_filetypes_doc.php',
        'tx_kesearch_indexer_filetypes_docx' => $extensionPath . 'indexer/filetypes/class.tx_kesearch_indexer_filetypes_docx.php',
	'tx_kesearch_indexer_filetypes_xls' => $extensionPath . 'indexer/filetypes/class.tx_kesearch_indexer_filetypes_xls.php',
	'tx_kesearch_indexer_filetypes_xlsx' => $extensionPath . 'indexer/filetypes/class.tx_kesearch_indexer_filetypes_xlsx.php',
